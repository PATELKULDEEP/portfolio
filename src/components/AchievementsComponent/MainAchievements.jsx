...
<a href="https://drive.google.com/file/d/1iaw-8BCG4L_BsOVmWmswa86WsbNjcex2/view?usp=sharing"  target="_blank" >Certificate</a>
        ...
        <div className='container'>
          ...
          <div className="card-sources">
              ...
              <a href="https://drive.google.com/file/d/1XNkYW_GY_PWnE53-nHgLNM6LdV1rwdBw/view?usp=sharing" target="_blank" >Certificate</a>
              </div>
...
trustworthy information about the availability of nearest centres</p>
          <div className="card-sources">
              ...
              <a href="https://docs.google.com/presentation/d/1AE3CDF_C96GWuRZzdLYYbjniMJikSz2F92cE6wRbYxg/edit?usp=sharing" target="_blank" >Presentation</a>
              </div>
              <div className="card-sources-link">
                  
                  <a href="https://covid19challenge.mit.edu/india/" target="_blank" >Winners</a>
                  </div>
          </div>
        </div>
      </div>
      <div className='card'>
        ...
        <div className='container'>
          <h4>
            <b>Getting Started with AWS</b>
          </h4>
          <p>learned the basics of AWS Machine Learning and how to use it by AWS Team in Coursera platform</p>
          <div className="card-sources">
              <div className="card-sources-link">

              <a href="https://drive.google.com/file/d/1APXYPYMI3tz7e2LlICKOIb0cl0z8M4LR/view?usp=sharing"  target="_blank" >Certificate</a>
              </div>
